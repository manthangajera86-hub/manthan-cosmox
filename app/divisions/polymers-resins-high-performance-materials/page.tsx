...
export default function Page() {
  return (
    <TopicPage family="divisions" slug="polymers-resins-high-performance-materials">
      <div><h4>Products</h4><ul className="list"><li>Polyimide</li><li>4,4′-(Hexafluoroisopropylidene)diphthalic anhydride</li><li>4,4′-Oxydianiline</li><li>Polybenzimidazole</li><li>Polyether Ketone Ketone</li><li>Polyetherimide</li><li>Hexafluoroisopropylidene Bisphenol</li><li>3,3′,4,4′-Biphenyltetracarboxylic dianhydride</li><li>Pyromellitic Dianhydride</li><li>4,4′-Diaminodiphenyl Sulfone</li><li>3,3′-Diaminodiphenyl sulfone</li></ul></div>
