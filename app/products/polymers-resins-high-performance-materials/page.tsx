...
export default function Page() {
  return (
    <TopicPage family="products" slug="polymers-resins-high-performance-materials">
      <div><h4>Products</h4><ul className="list"><li>Epoxy and phenolic resins</li><li>Polyurethane and polyamide intermediates</li><li>PTFE and fluoropolymer intermediates</li><li>Heat-resistant and functional polymers</li></ul></div>
